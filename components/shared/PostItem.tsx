      ...
      <div className="flex flex-row items-center gap-3 cursor-pointer">
        ...
        <div>
          <div className="flex flex-row items-center gap-2">
            <p className="text-neutral-300 text-[14px] font-medium cursor-pointer hover:underline">
              {post.user.name}
            </p>
            <span className="text-neutral-500 text-[13px] cursor-pointer hover:underline hidden md:block">
              {post.user.username
          ...
          <div className="text-white mt-1 text-[17px]">{post.body}</div>
